...
namespace DB.Migrations
{
    ...
    [Migration("20240515220556_KeyToToken")]
    partial class KeyToToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DB.Models.RepositoryModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DB.Models.SyncSetting", b =>
                {
                    ...
                    b.HasOne("DB.Models.RepositoryModel", "SourceRepository")
                        .WithOne()
                        .HasForeignKey("DB.Models.SyncSetting", "SourceRepositoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DB.Models.RepositoryModel", "TargetRepository")
                        .WithOne()
