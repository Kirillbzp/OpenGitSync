        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumDeleay = table.Column<long>(type: "bigint", nullable: false),
                    RepeatTaskInterval = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SyncStartType = table.Column<int>(type: "int", nullable: false),
                    SyncWay = table.Column<int>(type: "int", nullable: false),
                    StartTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ScheduleId = table.Column<long>(type: "bigint", nullable: false),
                    ProjectId = table.Column<long>(type: "bigint", nullable: false),
                    SourceRepositoryId = table.Column<long>(type: "bigint", nullable: false),
                    TargetRepositoryId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SyncSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SyncSettings_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SyncSettings_Repositories_SourceRepositoryId",
                        column: x => x.SourceRepositoryId,
                        principalTable: "Repositories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SyncSettings_Repositories_TargetRepositoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncSettings_ProjectId",
                table: "SyncSettings",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncSettings_SourceRepositoryId",
                table: "SyncSettings",
                column: "SourceRepositoryId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SyncSettings_TargetRepositoryId",
                table: "SyncSettings",
